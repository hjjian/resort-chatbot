...
def render_home():
    ...
    st.markdown("""
    <style>
    .event-banner-btn .stButton > button {
        background: linear-gradient(135deg,#2d5016 0%,#4a7c2f 50%,#6aab40 100%) !important;
        ...
        color: #fff !important;
        box-shadow: 0 2px 12px rgba(74,124,47,.25) !important;
        border: none !important;
    ...
    .event-banner-btn .stButton > button:hover {
        background: linear-gradient(135deg,#243f11 0%,#3d6b28 50%,#5a9535 100%) !important;
        transform: translateY(-1px) !important;
        box-shadow: 0 4px 16px rgba(74,124,47,.35) !important;
    }
    .event-banner-btn .stButton > button:active {
